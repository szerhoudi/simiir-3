...
class Additional Terms_Modified(SmarterQueryGenerator):
    """
    ...
    def generate_query_list(self, user_context):
        """
        Given a Topic object, produces a list of query terms that could be issued by the simulated agent. Test
        """
